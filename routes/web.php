...
Route::get('/cart/{id}', [productController::class, 'cart'])->name('cart_show');                                                //
...
Route::post('/update_profile', [userController::class, 'update_profile_post'])->name('update_profile_post');                    //
...
//admin
Route::get('/admin', [WebsiteController::class, 'admin'])->name('admin');
